    ...
    <>
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link
            class="nav-link fw-semibold text-white active"
            style={{ fontSize: "14px" }}
            to={"/"}
          >
            Home
                      ...
                      <div className="col-4">
                        ...
                        <div className="">
                          <Link
                            style={{ fontSize: "13px" }}
                            className="btn text-decoration-none text-dark fw-semibold py-2 text-start hover_link w-100"
                            to={`/collection/${"Symbols and signs"}`}
                          >
                            Symbols and signs
                          </Link>
                        </div>
                  ...
                  <div className="col-6">
                    <div className="">
                      <Link
                        style={{ fontSize: "13px" }}
                        className="btn text-decoration-none text-dark fw-semibold py-2 text-start hover_link w-100"
                        to={`/collection/${"Backgrounds and others"}`}
                      >
                    ...
                    <div className="">
                      <Link
                        style={{ fontSize: "13px" }}
                        className="btn text-decoration-none text-dark fw-semibold py-2 text-start hover_link w-100"
                        to={`/collection/${"Travel and places"}`}
                      >
                        Travel and places
                      </Link>
                    </div>
                    <div className="">
                      <Link
                        style={{ fontSize: "13px" }}
                        className="btn text-decoration-none text-dark fw-semibold py-2 text-start hover_link w-100"
                        to={`/collection/${"Business and technology"}`}
                      >
                  ...
                  <div className="col-6">
                    <div className="">
                      <Link
                        style={{ fontSize: "13px" }}
                        className="btn text-decoration-none text-dark fw-semibold py-2 text-start hover_link w-100"
                        to={`/collection/${"People and emotions"}`}
                      >
                        People and emotions
                      </Link>
                    </div>
                  ...
                  <div className="col-4">
                    ...
                    <div className="">
                      <Link
                        style={{ fontSize: "13px" }}
                        className="btn text-decoration-none text-dark fw-semibold py-2 text-start hover_link w-100"
                        to={`/collection/${"Invitation cards"}`}
                      >
                        Invitation cards
                      </Link>
                    </div>
