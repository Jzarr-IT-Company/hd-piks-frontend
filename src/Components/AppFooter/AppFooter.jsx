        ...
        >
          ...
          <div className="container p-4 pb-0" style={{ position: "relative", zIndex: 1 }}>
              ...
              <div className="row">
                ...
                <div className="col-lg-2 col-md-6 mb-4 mb-md-0">
                  ...
                  <ul className="list-unstyled mb-0">
                    ...
                    <li>
                      <Link to="/company/about-us" className="text-white">
                        About Us
                      </Link>
                    </li>
                    <li>
                      <Link to="/company/contact-us" className="text-white">
                        Contact Us
                      </Link>
                    </li>
                    <li>
            ...
            <section className="mb-4">
              <p className="d-flex justify-content-center align-items-center">
                <span className="me-3">Join us for exclusive content</span>
                <Link to="/signup" className="btn btn-outline-light btn-rounded">
                  Sign up!
                </Link>
              </p>
            </section>
