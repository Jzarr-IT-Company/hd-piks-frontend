...
function HomeBanner1() {   // home banner1 component
    ...
    // Treat each card as a subcategory collection -> open search for that subcategory
    const handle = (name) => {
    ...
    return (
        <>
            <div className="container d-none d-md-block py-4">
                ...
                {/* Use grid gap utilities instead of inline flex on row */}
