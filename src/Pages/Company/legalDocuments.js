export const LEGAL_DOCUMENTS = [
    {
        ...
        "sections":  [
                         ...
                         {
                             "heading":  "5. Warranties Regarding User-Provided Input",
                             "paragraphs":  [
                                                "The User warrants and represents they possess all necessary rights, licenses, and permissions to upload Input into the AI Products. In particular, the User warrants that:",
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Infringe, misappropriate, or violate intellectual property, image rights, or other rights of third parties.",
                                                "Generate spam, false, misleading, deceitful, harmful content to any person/group, or violent images.",
                                                "Use Outputs to distill, modify, or train another AI model, including transferring patterns, weights, parameters, activations, intermediate representations, or generating synthetic data intended to induce another model to function similarly.",
                                                ...
                                                "Generate content that includes nudity or shocking material, such as obscene gestures or other profane topics.",
                                                "Defame, slander, or vilify a person or group based on race, gender, culture, sexual orientation, religion, nationality, or other protected attributes.",
                                                "Generate or disseminate personally identifiable information that could be used to harm an individual.",
                                                "Exploit vulnerabilities of a specific group (e.g., based on age, social, physical, or mental characteristics) to materially distort behavior in a way that causes or may cause physical/psychological harm.",
                         ...
                         {
                             "heading":  "13. Special Terms for Specific Tools",
                             "paragraphs":  [
                                                "Certain tools may be powered by third parties. Where so, third-party terms apply and are incorporated by reference."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Impersonation: Outputs may not replicate or mimic artists’ voices or styles in a misleading manner or implying endorsement/association.",
                                                "Restricted sectors: the tool may not be used by Users operating in restricted sectors (e.g., weapons, tobacco, controlled substances, adult entertainment, political campaigns/advocacy), where required by provider policy.",
                                                "In the event of conflict between these AI Products Terms and the provider terms for the music tool, the provider terms prevail."
                                            ]
                         }
                     ]
    },
    {
        ...
        "sections":  [
                         ...
                         {
                             "heading":  "2.2 Documents forming the API Terms",
                             "paragraphs":  [
                         ...
                         {
                             "heading":  "3. Access and Permitted Use",
                             "paragraphs":  [
                                                "Customer must:",
                                                "comply with these API Terms and Developer Policies at all times;",
                                                ...
                                                "interfere with the stability, integrity, or security of the API Services;",
                                                "bypass rate limits, usage controls, or authentication mechanisms."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "5. Restrictions and Compliance",
                             "paragraphs":  [
                                                "Customer and API Client(s) must:",
                         ...
                         {
                             "heading":  "10. Plans, Billing, and Payments",
                             "paragraphs":  [
                                                "API pricing and plans are shown on the Developer Website (or in an Order Form if explicitly executed).",
                                                "Fees may be updated and the applicable price is generally the one shown at time of purchase/use unless otherwise agreed in an Order Form.",
                         ...
                         },
                         {
                             "heading":  "11.1 Term",
                             "paragraphs":  [
                                                "These API Terms remain in effect while Customer uses API Services or maintains an API plan.",
                                                "Subscriptions may auto-renew unless canceled before renewal per the cancellation window shown on the Website or Order Form."
                                            ]
                         },
                         {
                             "heading":  "11.2 Termination for Cause",
                             "paragraphs":  [
                                                "Either Party may terminate if the other materially breaches and fails to cure within 30 days after written notice, or if repeated breaches occur, or insolvency events occur as legally applicable."
                                            ]
                         },
                         {
                             "heading":  "11.3 Effects of Termination",
                             "paragraphs":  [
                                                "Upon termination/suspension:",
                                                "Customer must immediately stop using API Services;",
                                                "delete Confidential Information and any stored API materials as required;",
                         ...
                         {
                             "heading":  "16.1 Governing Law and Jurisdiction",
                             "paragraphs":  [
                                                "“These API Terms are governed by the laws of Pakistan, and disputes will be resolved in the courts of Karachi.”"
                                            ]
                         }
                     ]
    },
        ...
        "sections":  [
                         {
                             ...
                             "paragraphs":  [
                                                "Subject to this Agreement, the Business subscription provides the Business Customer the right to access and use the Services under an organizational, multi-user model, solely for the Business Customer’s internal business or professional purposes, during the applicable subscription term.",
                                                "The Business subscription is a standardized, self-service offering and is not customized for your specific needs. Features, limits, and pricing are those shown on the Website at the time of purchase, and may be updated in accordance with these Terms.",
                                                "Access may be managed through a centralized account and shared usage mechanisms, subject to the conditions in these Business Subscription Terms."
                                            ]
                         },
                         {
                             "heading":  "1.2 Business Subscription Benefits",
                             "paragraphs":  [
                                                "Based on the plan details shown on the Website from time to time, the Business Customer may receive access to:"
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "2.1 Business Account and Roles",
                             "paragraphs":  [
                         ...
                         {
                             "heading":  "2.2 Authorized Users and Eligibility",
                             "paragraphs":  [
                                                "Access is limited to Authorized Users, meaning individuals who are employees or internal members of the Business Customer.",
                                                "Unless explicitly allowed on the Website, Authorized Users do not include:",
                                                "External contractors/freelancers/consultants",
                                                "Clients, partners, or third parties",
                                                "Users from sister companies/affiliates within a group",
                                                "The Business subscription is for the Business Customer’s internal use only. Allowing access to ineligible users is a material breach."
                                            ]
                         },
                         {
                             "heading":  "2.3 Seats and User Lifecycle",
                             "paragraphs":  [
                                                "Seats represent the maximum number of Authorized Users who can access the Services at the same time.",
                                                "The Account Owner may add/remove/replace users up to the seat limit.",
                                                "Removing a user does not reduce seats automatically.",
                                                "Seats cannot be shared concurrently by multiple people.",
                                                "Seat reductions (downgrades) take effect at renewal unless the Website states otherwise."
                                            ]
                         },
                         {
                             "heading":  "2.4 Usage Credits (Account-Level)",
                             "paragraphs":  [
                                                "If your plan includes credits, they are allocated to the Business Account and shared across Authorized Users. Credits are not user-specific and do not become “property” of any individual user.",
                                                "Credits remain available regardless of user replacements, subject to expiration/rollover rules in Section 3 and the Website."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "3.3 Seat and Plan Modifications",
                             "paragraphs":  [
                                                "You may increase seats at any time through self-service tools. Increases are effective immediately and may incur additional charges.",
                                                "Seat reductions apply at the end of the current term unless the Website says otherwise.",
                                                "Changes between monthly/annual billing follow the rules shown on the Website."
                                            ]
                         },
                         {
                             "heading":  "3.4 Usage Credits and Rollover",
                             "paragraphs":  [
                                                "If rollover is offered, rollover duration and expiry rules are defined on the Website.",
                                                "Unused credits:",
                                                "may expire at end of cycle if rollover is not offered, or",
                                                "may expire after rollover window ends, or",
                                                "expire immediately upon cancellation/termination (see Section 4)"
                                            ]
                         },
                         {
                             "heading":  "3.5 Extra Credits and Add-ons",
                             "paragraphs":  [
                                                "The Account Owner may purchase Extra Credits or add-ons if available.",
                                                "Unless stated otherwise:",
                                                "Extra Credits are charged at purchase and non-refundable",
                                                "Extra Credits are valid for up to 3 years from purchase date (or as shown on the Website)",
                                                "Extra Credits are used only after included plan credits are exhausted",
                                                "Auto-refill can be enabled if available, authorizing recurring charges"
                                            ]
                         },
                         {
                             "heading":  "4.1 Cancellation by Business Customer",
                             "paragraphs":  [
                                                "You may cancel anytime through the Business Account.",
                                                "Unless required by law, cancellation takes effect at the end of the current term. Access continues until term ends.",
                                                "No refunds or credits are due for unused seats/services/credits/extra credits."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "4.3 Effects of Termination/Expiration",
                             "paragraphs":  [
                                                "Upon termination/expiration:(a) all rights to use Business subscription end immediately;(b) unused credits and extra credits expire without compensation;(c) you remain responsible for charges incurred before termination.",
                                                "Sections intended to survive (IP, disclaimers, limits, indemnity, etc.) remain in force."
                                            ]
                         },
                         {
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "If you want: main yahan “If Offered” wali line hata kar hard commitment bana doon — lekin phir legally risky ho sakta hai agar aap actually indemnity offer nahi karte."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "5.4 Mitigation Rights",
                             "paragraphs":  [
                                                "If we believe a specific Output may create legal risk, we may require you to stop using it immediately. We are not obligated to replace, modify, or procure licenses for Outputs."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "7. AI Terms Not Included Here",
                             "paragraphs":  [
    ...
    },
    {
        ...
        "sections":  [
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                "You agree NOT to:",
                                                "Use bots, scraping tools, spiders, or automation to extract data",
                                                "Overload servers or interfere with infrastructure",
                         ...
                         {
                             "heading":  "5.4 AI-Generated Content",
                             "paragraphs":  [
                                                "If you use AI features:",
                                                "AI Content is governed by separate AI Product Terms",
                                                "AI output may not be unique",
                                                "You are responsible for lawful use of generated output",
                                                "You must not use AI tools to generate unlawful, infringing, or harmful content"
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Sub-licensable",
                                                "Perpetual",
                                                "license to host, display, process, reproduce, and distribute such content solely for operating, improving, and promoting the Service."
                                            ]
                         },
                         {
                             "heading":  "6.2 Your Responsibilities",
                             "paragraphs":  [
                                                "You represent that:",
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Extract database content systematically",
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "That content is accurate or suitable for specific purposes",
                                                "That AI output is unique or legally safe",
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Unauthorized access",
                                                "Third-party misuse",
                                                "Our total liability, where applicable, shall not exceed the amount paid by you in the preceding 12 months (if any)."
                                            ]
                         },
                         {
                             "heading":  "13. Changes \u0026 Termination",
                             "paragraphs":  [
                                                "We may:",
                                                ...
                                                "Impose usage limits",
                                                "Terminate access",
                                                "We will comply with legal retention obligations where required."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "[Insert competent courts or arbitration clause]",
    ...
    },
    {
        ...
        "sections":  [
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                "Our Services are intended for users who are of legal age in their jurisdiction.If a feature is explicitly available for minors, it must be reviewed and accepted by a parent/legal guardian where required by law.",
                                                "If you are a minor and cannot legally enter a contract in your jurisdiction, you must not use paid Services or accept subscription agreements without lawful authorization."
                                            ]
                         },
                         {
                             "heading":  "3) What data we collect and why (Purposes + Legal Bases)",
                             "paragraphs":  [
                                                "We process personal data for different purposes. Depending on your location and applicable law, our lawful bases may include:",
                                                "Consent (you agree to a specific purpose)",
                                                "Contract (necessary to provide Services or manage an account/subscription)",
                         ...
                         {
                             "heading":  "3.1 Browsing \u0026 basic use (even without registration)",
                             "paragraphs":  [
                                                "When you browse the Services, we may collect technical and usage data automatically, such as:",
                                                "IP address, device identifiers, browser type, OS, language, time zone",
                                                "log data (pages viewed, referral URLs, timestamps)",
                                                "basic usage metrics (downloads/search count, feature interactions)",
                                                "Purposes: security, fraud prevention, service operation, rate limiting, enforcing Terms, analytics (where permitted).Legal basis: legitimate interests (security \u0026 service integrity) and/or consent (for analytics/ads cookies where required)."
                                            ]
                         },
                         {
                             "heading":  "3.2 Account registration (Free or Paid)",
                             "paragraphs":  [
                                                "When you create an account, we may collect:",
                                                "username, email, password (hashed), profile details you add voluntarily",
                                                "if you subscribe: billing details and tax-related info (where required), country/city, transaction metadata",
                                                "Purposes: create/manage accounts, provide features, support, billing, compliance.Legal basis: contract + legal obligations (billing/tax) + legitimate interests (security).",
                                                "Important: Payment card data is typically handled by payment processors; we generally do not store full card details."
                                            ]
                         },
                         {
                             "heading":  "3.3 Social login / federated login (optional)",
                             "paragraphs":  [
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "payment details (via processor)",
                                                "tax residence/verification documents (where required)",
                                                "Purposes: onboarding, licensing, payouts, compliance.Legal basis: contract + legal obligation."
                                            ]
                         },
                         {
                             "heading":  "3.5 Models / persons appearing in content (where relevant)",
                             "paragraphs":  [
                                                "If you appear in images/videos distributed through the Services (e.g., as a model), we may process:",
                                                "contract/release documentation details (for verification and compliance)",
                                                "the image/voice included in content",
                                                "Purposes: licensing operations, compliance, dispute handling, content distribution.Legal basis: contract and legitimate interests; legal obligations where applicable.",
                                                "(If you want a strict stance: “we do not use model release ID docs for AI training.” We can keep it.)"
                                            ]
                         },
                         {
                             "heading":  "3.6 Marketing emails \u0026 service communications",
                             "paragraphs":  [
                                                "We may send:",
                                                "transactional emails (security notices, invoices, account confirmations)",
                                                "product updates and marketing emails (where allowed)",
                                                "Legal basis:",
                                                "transactional: contract/legitimate interests",
                                                "marketing: consent and/or legitimate interests (depending on local law)You can opt out anytime via “unsubscribe” links or account settings."
                                            ]
                         },
                         {
                             "heading":  "3.7 Advertising \u0026 cookies (where enabled)",
                             "paragraphs":  [
                                                "We may display ads or measure conversions using cookies/trackers, only where permitted and typically based on your consent.",
                                                "More details are in our Cookies Policy, including how to manage cookie settings."
                                            ]
                         },
                         {
                             "heading":  "3.8 Surveys \u0026 feedback",
                             "paragraphs":  [
                                                "We may request feedback through surveys to improve Services.",
                                                "Data: contact info and your responses (if you choose to participate).Legal basis: legitimate interests and/or consent (depending on the survey)."
                                            ]
                         },
                         {
                             "heading":  "3.9 Support (including AI-assisted support where offered)",
                             "paragraphs":  [
                                                "If you contact support, we process:",
                                                "your contact info, message content, device/browser info, timestampsIf we offer AI-assisted support tools, they may process your request text to help respond.",
                                                "Purposes: provide support, resolve issues, improve support quality.Legal basis: contract/legitimate interests; consent where required."
                                            ]
                         },
                         {
                             "heading":  "3.10 Job applications",
                             "paragraphs":  [
                                                "If you apply for a role or freelance collaboration, we may process:",
                                                "CV/resume, contact details, application info",
                                                "Legal basis: consent and/or pre-contract steps."
                                            ]
                         },
                         {
                             "heading":  "3.11 Third-party integrations / APIs / plugins",
                             "paragraphs":  [
                                                "We may integrate third-party tools (analytics, support widgets, performance/security providers, etc.). These providers may process limited data under our instructions as processors (or in some cases, as independent controllers).",
                                                "We recommend reviewing relevant third-party notices where applicable."
                                            ]
                         },
                         {
                             "heading":  "3.12 AI-based products (summary only — AI Terms separate)",
                             "paragraphs":  [
                                                "If you use AI tools, we may process:",
                                                "Inputs you provide (e.g., prompts, uploads)",
                                                "Outputs generated by the tools",
                                                "account and technical data needed to run the service",
                                                "Purposes: provide AI tools, security, abuse prevention, product improvement (as allowed).Important: Your AI usage is governed by separate AI Terms of Use and related policies displayed in the product."
                                            ]
                         },
                         {
                             "heading":  "3.13 Legal obligations",
                             "paragraphs":  [
                                                "We may process and disclose data where required by law (e.g., tax, compliance, lawful requests by authorities)."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "4) Data retention (How long we keep data)",
                             "paragraphs":  [
                                                "We keep personal data only as long as necessary for the purposes described, including legal and contractual requirements. Typical retention examples:",
                                                "security logs / fraud prevention: up to [13 months] (editable)",
                                                "account data: as long as the account is active + [5 years] for legal claims (editable)",
                                                "billing/tax records: [6 years] or as required by law",
                                                "marketing communications: until opt-out or [3 years] from last interaction (editable)",
                                                "support tickets: until resolved + [X years] for dispute/claims (editable)",
                                                "job applications: [12 months] (editable)",
                                                "Actual periods may vary based on law and operational needs."
                                            ]
                         },
                         {
                             "heading":  "5) Data accuracy",
                             "paragraphs":  [
                                                "You are responsible for keeping your account information accurate and updated. If your details change, please update your profile or contact support."
                                            ]
                         },
                         {
                             "heading":  "6) Sharing \u0026 disclosure (Who receives your data)",
                             "paragraphs":  [
                                                "We may share data with:",
                                                "Service providers (hosting, security, analytics, customer support, email delivery)",
                                                "Payment processors and financial partners (subscriptions, refunds, fraud checks)",
                                                "Advertising and marketing partners (only where enabled/consented)",
                                                "Professional advisors (lawyers, auditors, accountants)",
                                                "Authorities (when legally required)",
                                                "We require service providers to protect data and process it under appropriate contractual safeguards."
                                            ]
                         },
                         {
                             "heading":  "7) Your rights",
                             "paragraphs":  [
                                                "Depending on your location and law, you may have rights including:",
                                                "access to your data",
                         ...
                         },
                         {
                             "heading":  "8) Security",
                             "paragraphs":  [
                                                "We use technical and organizational measures to protect personal data. However, no system is 100% secure.You should use strong passwords, avoid sharing credentials, and use unique passwords across services."
                                            ]
                         },
                         {
                             "heading":  "9) International transfers",
                             "paragraphs":  [
                                                "Your data may be processed in countries outside your jurisdiction depending on provider locations. Where required, we use appropriate safeguards (e.g., contractual protections) for cross-border transfers."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "11) Additional Information for California Residents (Optional CCPA Section)",
                             "paragraphs":  [
                                                "This section applies only if you are a California resident and the CCPA/CPRA applies."
                                            ]
                         },
                         {
                             "heading":  "11.1 Categories of personal information collected",
                             "paragraphs":  [
                                                "We may collect:",
                                                "identifiers (name, email, IP)",
                                                "account records and profile info",
                                                "internet activity data (usage, logs)",
                                                "approximate geolocation",
                                                "commercial information (subscriptions/transactions)",
                                                "inferences (preferences, usage patterns)",
                                                "sensitive data only as necessary for permitted purposes (e.g., identity verification where required)"
                                            ]
                         },
                         {
                             "heading":  "11.2 Sale/Share of personal information",
                             "paragraphs":  [
                                                "We do not sell personal information for money in the traditional sense.However, certain advertising/analytics cookies may be considered “selling” or “sharing” under California law. You can opt out via cookie settings and “Do Not Sell/Share” controls (if implemented).",
                                                "We do not knowingly sell/share personal information of users under 16."
                                            ]
                         },
                         {
                             "heading":  "11.3 California rights",
                             "paragraphs":  [
                                                "You may have the right to:",
                                                "know/access categories and specific pieces of data",
        ...
        "sections":  [
                         {
                             ...
                             "paragraphs":  [
                                                "Cookies are small text files stored on your device when you visit a website. They help websites remember information about your visit, such as login status, language preferences, and settings.",
                                                "We may also use technologies that function similarly to cookies, such as:",
                                                "Pixels / tags (small tracking scripts)",
                                                "SDKs (in mobile apps)",
                                                "Local storage (browser storage)",
                                                "Server logs (which may include IP address and device data)",
                                                "These technologies may help us recognize your browser/device, understand usage patterns, improve performance, and (where permitted) personalize content and advertising."
                                            ]
                         },
                         {
                             "heading":  "2) Why we use cookies",
                             "paragraphs":  [
                                                "We generally use cookies for these purposes:"
                                            ]
                         },
                         {
                             "heading":  "(A) Strictly Necessary Cookies",
                             "paragraphs":  [
                                                "Required for core functions (e.g., login sessions, security, fraud prevention, load balancing). These are typically always on because the Service cannot function properly without them."
                                            ]
                         },
                         {
                             "heading":  "(B) Functional Cookies",
                             "paragraphs":  [
                                                "Help remember choices such as language, region, and interface preferences."
                                            ]
                         },
                         {
                             "heading":  "(C) Analytics / Measurement Cookies",
                             "paragraphs":  [
                                                "Help us understand how users interact with the Website (e.g., pages visited, time spent, errors) so we can improve performance and user experience."
                                            ]
                         },
                         {
                             "heading":  "(D) Performance \u0026 Security Cookies",
                             "paragraphs":  [
                                                "Help detect suspicious activity, protect against abuse/bots, and maintain service reliability."
                                            ]
                         },
                         {
                             "heading":  "(E) Advertising / Targeting Cookies (Optional)",
                             "paragraphs":  [
                                                "Used (only where permitted) to measure ad performance and show relevant marketing (e.g., retargeting). These cookies may be set by us or by advertising partners."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Cookie Banner / Settings Panel (Recommended)If we provide a cookie preference panel on the Website, you can accept/reject cookie categories and change your preferences any time via the “Cookie Settings” link in the Website footer (or the cookie banner).",
                                                "Browser SettingsMost browsers allow you to:",
                                                "block cookies entirely",
                                                "block third-party cookies",
                                                "delete existing cookies",
                                                "receive alerts when cookies are set",
                                                "Mobile Device Controls (Apps)Mobile operating systems may let you limit ad tracking or reset ad identifiers.",
                                                "Note: If you block certain cookies (especially necessary/functional cookies), some Website features may not work properly (e.g., login, saved settings, checkout)."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "5) Types of cookies we may use (examples)",
                             "paragraphs":  [
                                                "The exact cookies may vary based on the features you use and your consent settings.",
                                                "Common first-party cookie examples (Purpose-based)",
                                                "Session \u0026 authentication (keep you logged in, manage sessions)",
                                                "Security (CSRF protection, abuse prevention)",
                                                "Preferences (language, UI settings)",
                                                "Purchase / billing flow (where applicable)",
                                                "Common third-party cookie/provider categories (if enabled)",
                                                "Analytics tools (e.g., traffic measurement and behavior insights)",
                                                "Performance \u0026 security (e.g., bot detection, DDoS protection)",
                                                "Support \u0026 CRM tools (e.g., helpdesk, chat widgets)",
                                                "Advertising platforms (e.g., conversion measurement, retargeting)",
                                                "If you want, I can create a clean cookie table template (Purpose / Provider / Cookie name / Duration / Category) for your developer to fill with the real cookies from your production site."
                                            ]
                         },
                         {
                             "heading":  "6) Advertising and measurement (where enabled)",
                             "paragraphs":  [
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                "Depending on the location of our providers and infrastructure, some data collected through cookies may be processed outside your country. Where required, we rely on appropriate safeguards (such as contractual protections) for cross-border transfers."
                                            ]
                         },
                         {
                             "heading":  "8) Changes to this Cookies Policy",
                             "paragraphs":  [
                                                "We may update this Cookies Policy from time to time. We encourage you to review it periodically. If we make material changes, we may notify you through the Website, banner, or other reasonable means.",
                                                "Last edited: 1st March 2026"
                                            ]
                         },
                         {
                             "heading":  "9) Contact",
        ...
        "sections":  [
                         {
                             ...
                             "paragraphs":  [
                                                "You agree that you will not upload content, generate outputs, create designs, distribute materials, or otherwise use the Products, directly or indirectly, in any manner that:"
                                            ]
                         },
                         {
                             "heading":  "(A) Harm \u0026 Safety",
                             "paragraphs":  [
                                                "Promotes or creates a risk of physical harm, mental harm, emotional distress, death, disability, or disfigurement to any person or animal;",
                                                "Promotes self-harm or harm to others;",
                                                "Encourages dangerous activities that could result in injury or property damage;",
                                                "Seeks to harm, exploit, or abuse minors in any way."
                                            ]
                         },
                         {
                             "heading":  "(B) Harassment \u0026 Abuse",
                             "paragraphs":  [
                                                "Is harassing, abusive, hateful, threatening, or defamatory;",
                                                "Is racially, ethnically, or religiously offensive;",
                                                "Invades personal privacy or publicity rights;",
                                                "Encourages violence, intimidation, or coercion;",
                                                "Promotes discrimination based on race, religion, sex, gender, sexual orientation, age, disability, ancestry, nationality, or any protected characteristic."
                                            ]
                         },
                         {
                             "heading":  "(C) Illegal Activities",
                             "paragraphs":  [
                                                "Involves the sale, promotion, or facilitation of illegal goods, services, or activities;",
                                                "Violates any applicable local, national, or international law;",
                                                "Promotes fraudulent schemes, scams, deceptive practices, or impersonation;",
                                                "Encourages unlawful hacking, data theft, bypassing security measures, or misuse of digital systems."
                                            ]
                         },
                         {
                             "heading":  "(D) Intellectual Property \u0026 Rights Violations",
                             "paragraphs":  [
                                                "Infringes intellectual property rights, including copyrights, trademarks, patents, or trade secrets;",
                                                "Violates data protection or privacy laws;",
                                                "Uses personal data without proper authorization;",
                                                "Includes confidential information you are not legally permitted to disclose."
                                            ]
                         },
                         {
                             "heading":  "(E) False or Misleading Content",
                             "paragraphs":  [
                                                "Contains false, deceptive, or misleading information;",
                                                "Promotes disinformation or manipulation;",
                                                "Impersonates any individual, organization, or authority;",
                                                "Misrepresents the source, origin, or authenticity of content."
                                            ]
                         },
                         {
                             "heading":  "(F) Political \u0026 Democratic Integrity",
                             "paragraphs":  [
                                                "Threatens or undermines democratic processes or institutions;",
                                                "Seeks to manipulate elections or public policy unlawfully."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Allow third parties to access or use your account;",
                                                "Use automation, bots, scripts, crawlers, or scraping tools to access the Products;",
                                                "Generate content in bulk using automated systems;",
                                                "Extract metadata or content at scale;",
                                                ...
                                                "Such actions will be proportionate to the violation. Where appropriate, the User may be notified of the reason and provided with a contact channel for review."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "You must not use AI outputs to violate rights, laws, or ethical standards.",
                                                "“Unlimited” features (where applicable) are subject to fair-use safeguards and technical limits designed to prevent abuse."
                                            ]
                         },
                         {
        ...
        "sections":  [
                         {
                             ...
                             "paragraphs":  [
                                                "Copyright",
                                                "Copyright is a legal right that protects original works of authorship, including but not limited to:",
                                                "Photographs",
                                                ...
                                                "Videos",
                                                "Written works",
                                                "The copyright owner generally has exclusive rights to reproduce, distribute, display, modify, and create derivative works from the protected content.",
                                                "Copyright protects the original expression of ideas, not the ideas themselves. Names, titles, and short phrases are typically not protected by copyright but may be protected under trademark law.",
                                                "Trademark",
                                                "A trademark is a word, phrase, symbol, logo, design, or combination thereof that identifies and distinguishes the source of goods or services of one party from another.",
                                                "Trademark laws are designed to prevent consumer confusion regarding the origin, sponsorship, or affiliation of products or services.",
                                                "Unauthorized use of trademarks in a way that may cause confusion or imply false endorsement may constitute trademark infringement."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Telephone number",
                                                "Email address",
                                                "Statement of good faithA statement that you have a good faith belief that the disputed use is not authorized by the intellectual property owner, its agent, or the law.",
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Removing or disabling access to the reported content;",
                                                "Restricting content in specific jurisdictions;",
                                                "Requesting additional information from the complainant;",
                                                "Notifying the content uploader or account holder.",
                                                "We may share the complainant’s name and email address with the alleged infringer where required for legal or dispute resolution purposes."
                                            ]
                         },
                         {
                             "heading":  "5. Counter-Notification Process",
                             "paragraphs":  [
                                                "If content you uploaded has been removed or restricted due to a claim and you believe this action was taken in error or based on misidentification, you may submit a counter-notification through the same official channel used to communicate the claim.",
                         ...
                         {
                             "heading":  "7. Fraudulent or Misleading Claims",
                             "paragraphs":  [
                                                "Submitting false, misleading, or fraudulent intellectual property claims may result in:",
                                                "Termination of your account;",
                                                "Legal consequences;",
                                                "Liability for damages where applicable.",
                                                "We strongly recommend consulting a legal professional before filing a claim if you are uncertain about your rights."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "to identify and remove content that may infringe intellectual property rights.",
                                                "We continuously improve our systems to protect creators, contributors, and rights holders."
                                            ]
                         }
                     ]
    },
    {
        ...
        "sections":  [
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                "The User may use the Website and Services only in good faith and in compliance with these Terms and the Acceptable Use Policy.",
                                                "Users (whether subscribed or not) agree that downloads, access, and interactions must reflect a genuine legitimate interest. Any method that artificially increases downloads, access, or clicks is prohibited, including the use of robots, spiders, scrapers, scripts, automation, programs or tools without the Company’s prior written authorization. Breach may result in account cancellation and the User’s obligation to indemnify the Company for damages caused by the breach, without refund.",
                                                "The User must not misuse the Services, act unlawfully, or engage in conduct that harms the Website, the Company, or third parties. The User must not interfere with the Website’s functioning or security, impersonate others, overload systems, or attempt to access content through unauthorized methods.",
                                                "The User is responsible for ensuring the Services meet their needs and for having required equipment/software.",
                                                "Rights granted under these Terms are personal and cannot be assigned or transferred to any third party without the Company’s prior written consent.",
                                                "The Website may display advertising, which the User accepts."
                                            ]
                         },
                         {
                             "heading":  "3. Registration",
                             "paragraphs":  [
                                                "Some Services require registration. The User must provide a valid email address and keep account information accurate and up to date.",
                                                "The User must keep login credentials confidential and is responsible for activity performed through the account. If unauthorized use is suspected, the User must promptly notify the Company.",
                                                "The Company may suspend or cancel accounts for breach of these Terms."
                                            ]
                         },
                         {
                             "heading":  "4. Content",
                         ...
                         {
                             "heading":  "4.1 Sponsored Content",
                             "paragraphs":  [
                                                "Sponsored Content is provided by third parties. The Company’s role is limited to displaying sponsored listings and links. The Company is not the owner/provider of Sponsored Content and does not endorse or guarantee it. The User accesses Sponsored Content under the third party’s terms."
                                            ]
                         },
                         {
                             "heading":  "4.2 Company Content",
                             "paragraphs":  [
                                                "Company Content is provided under conditions shown on the Website, including any download limits, usage rules, or subscription requirements."
                                            ]
                         },
                         {
                             "heading":  "4.3 Contributor Content",
                             "paragraphs":  [
                                                "Contributor Content is provided by third parties. The Company may act as an intermediary by hosting and providing access to such content. The Company cannot monitor all Contributor Content and is not responsible for its legality/originality except where required by applicable law."
                                            ]
                         },
                         {
                             "heading":  "4.4 AI-Related Features",
                             "paragraphs":  [
                                                "If AI features are available, they may be subject to credits/limits and separate AI Terms. The AI Terms govern AI usage and AI-generated outputs (where applicable)."
                                            ]
                         },
                         {
                             "heading":  "5. Storage and Offer of Contributor Content",
                             "paragraphs":  [
                                                "Where the Company hosts Contributor Content as intermediary, the contributor remains solely responsible for the Contributor Content. The Company does not necessarily endorse it and is not obligated to pre-approve it."
                                            ]
                         },
                         {
                             "heading":  "6.1 Users’ Liability",
                             "paragraphs":  [
                                                "The User uses the Website and Services at their own risk and is responsible for misuse or breach. The User agrees to indemnify the Company for damages arising from breach of these Terms.",
                                                "The Company does not warrant uninterrupted availability, error-free operation, or fitness for a particular purpose. The Company is not liable for issues caused by viruses, outages, network failures, internet congestion, third-party actions, maintenance, updates, or events beyond the Company’s control."
                                            ]
                         },
                         {
                             "heading":  "6.2 Company’s Liability",
                             "paragraphs":  [
                                                "Except for wilful misconduct and except where liability cannot be limited under applicable law, the Company is not liable for damages arising from use of the Website/Services. The Company is not responsible for Sponsored Content or third-party websites linked from the Website, except as required by applicable law."
                                            ]
                         },
                         {
                             "heading":  "6.3 Limitation of Liability",
                             "paragraphs":  [
                                                "To the maximum extent permitted by law, the Company’s total liability is limited as stated on the Website and/or in the applicable subscription terms, and in any case limited to direct damages only (where limitation is permitted)."
                                            ]
                         },
                         {
                         ...
                         },
                         {
                             "heading":  "9.1 General",
                             "paragraphs":  [
                                                "This section (“Subscription Conditions”) applies to purchases of individual subscriptions offered on the Website. By completing a purchase, the User accepts these Subscription Conditions.",
                                                "Subscriptions are billed monthly (unless otherwise stated) and may auto-renew unless the User cancels renewal before the next billing date. Subscription benefits remain active until the end of the paid billing period.",
                                                "Credits \u0026 expiry: Where a plan includes monthly credits, credits are allocated per billing period and are valid for 1 month. Unused monthly credits may not carry over unless the Website explicitly states otherwise. The Company may offer top-up credits for purchase at any time, subject to availability on the Website.",
                                                "AI Terms separate: Any AI usage, outputs, model availability, “unlimited” eligibility, and restrictions are governed by the separate AI Terms and product rules shown on the Website."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "(A) Basic — USD $10/month (Billed monthly)",
                             "paragraphs":  [
                                                "For beginners \u0026 casual creators / hobbyists. Includes:",
                                                "1,000 credits/month",
                                                "Access to all image, video \u0026 audio models",
                                                "Spaces: shared canvas, built for workflows",
                                                "Pro editing tools: image, video \u0026 design",
                                                "Commercial AI license",
                                                "Magnific image \u0026 video upscalers",
                                                "200M+ photos, videos, vectors \u0026 PSDs",
                         ...
                         {
                             "heading":  "(B) Advance — USD $25/month (Billed monthly)",
                             "paragraphs":  [
                                                "For designers \u0026 marketers / individuals creating with Premium stock and AI tools. Includes:",
                                                "7,000 credits/month",
                                                "Plus 200M+ Premium stock assets",
                                                "Access to all image, video \u0026 audio models",
                                                "Spaces: shared canvas, built for workflows",
                                                "Pro editing tools: image, video \u0026 design",
                                                "Music, voice \u0026 sound effects generation",
                                                "Commercial AI license",
                                                "Magnific image \u0026 video upscalers",
                                                "Train AI styles, characters \u0026 products",
                                                "200M+ photos, videos, vectors \u0026 PSDs",
                                                "Top up credits anytime",
                                                "Early access to AI features",
                                                "Lowest cost per credit",
                         ...
                         {
                             "heading":  "(C) Pro Plus — USD $70/month (Billed monthly)",
                             "paragraphs":  [
                                                "For advanced AI \u0026 content creators / creatives wanting unlimited generations and flexible usage. Includes:",
                                                "15,000 credits/month",
                                                "Plus UNLIMITED on selected models (subject to AI Terms and fair-use safeguards)",
                                                "Access to all image, video \u0026 audio models",
                                                "Spaces: shared canvas, built for workflows",
                                                "Pro editing tools: image, video \u0026 design",
                                                "Music, voice \u0026 sound effects generation",
                                                "Commercial AI license + music rights",
                                                "Magnific \u0026 Topaz upscalers",
                                                "Train AI styles, characters \u0026 products",
                                                "200M+ photos, videos, vectors \u0026 PSDs",
                                                "Top up credits anytime",
                                                "Early access to AI features",
                                                ...
                                                "Credits valid for 1 month",
                                                "Get Unlimited",
                                                "Learn more: Credit-free on selected included AI models/tools as shown on the Website (e.g., Google Nano Banana Pro, ElevenLabs Pro, ChatGPT Plus, ImageKit Pro)",
                                                "100M+ Premium assets"
                                            ]
                         },
                         {
                             "heading":  "9.3 Modifying or Canceling",
                             "paragraphs":  [
                                                "Users may upgrade through their account where available. Cancellation stops renewal; the plan remains active until the end of the billing period. Any remaining monthly credits expire according to the credit validity rules (typically within the month)."
                                            ]
                         },
                         {
                             "heading":  "9.4 Changes to Plans",
                             "paragraphs":  [
                                                "The Company may update pricing plans, benefits, included tools/models, and credit costs from time to time. Any changes will be reflected on the Website and, where required, communicated to Users."
                                            ]
                         },
                         {
                             "heading":  "10. Changes and Closure",
                             "paragraphs":  [
                                                "The Company may modify or discontinue Services, features, or Website content at any time. Where required by law or stated on the Website, refunds for active subscriptions (if any) will follow the Company’s stated refund policy."
                                            ]
                         },
                         {
                             "heading":  "11. General and Contact",
                             "paragraphs":  [
                                                "These Terms are governed by the law and jurisdiction stated on the Website (or as required by applicable law). If any provision is held invalid, the remaining provisions remain effective.",
                                                "For queries or claims, contact the Company via the support channel provided on the Website."
                                            ]
                         }
                     ]
    },
        ...
        "sections":  [
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Discover content created by other Users",
                                                "Interact, collaborate, and communicate within the community",
                                                "If AI tools are used within the Creator Community, such use is governed by the separate AI Terms of Use, which form part of the contractual framework by reference."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Worldwide",
                                                "Royalty-free",
                                                "Transferable (for operational purposes only)",
                                                "Sub-licensable (to service providers only)",
                                                "license to use, reproduce, display, distribute, adapt, modify, and create derivative works of your content solely for:",
                         ...
                         {
                             "heading":  "2.2 License to Other Users",
                             "paragraphs":  [
                                                "You grant other Users of the Creator Community a non-exclusive license to access and use your publicly shared User Content through the platform functionality, subject to these Terms and any applicable license restrictions."
                                            ]
                         },
                         {
                         ...
                         {
                             "heading":  "3. User Responsibilities \u0026 Community Standards",
                             "paragraphs":  [
                                                "By using the Creator Community, you agree to:"
                                            ]
                         },
                         {
                             "heading":  "(A) Legal Compliance",
                             "paragraphs":  [
                                                "Use the platform in compliance with all applicable local, national, and international laws."
                                            ]
                         },
                         {
                             "heading":  "(B) Ownership \u0026 Permissions",
                             "paragraphs":  [
                                                "Ensure you own or have obtained all necessary rights, licenses, and permissions to publish your content."
                                            ]
                         },
                         {
                             "heading":  "(C) Content Integrity",
                             "paragraphs":  [
                                                "Ensure your content does not:",
                         ...
                         {
                             "heading":  "(D) Authentic Identity",
                             "paragraphs":  [
                                                "You must not:",
                                                "Use fake or misleading information",
                                                "Impersonate another person or entity",
                                                "Falsely claim authorship of content"
                                            ]
                         },
                         {
                             "heading":  "(E) Platform Security",
                             "paragraphs":  [
                                                "You must not upload malicious code, viruses, spyware, or harmful software."
                                            ]
                         },
                         {
                         ...
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Suspend or terminate accounts",
                                                "If you believe content violates these Terms, the Acceptable Use Policy, or any community guidelines, you may report it through the official reporting channels provided on the Website."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Initiating legal action (where necessary)",
                                                "Users may be held liable for damages caused by violations."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "We will notify you of any such claim and may request your cooperation in defending it."
                                            ]
                         },
                         {
                             ...
                             "paragraphs":  [
                                                ...
                                                "Deactivate accounts",
                                                "We are not liable for modifications or discontinuation of services."
                                            ]
                         },
                         {
...
export const findLegalDocumentBySlug = (slug) =>
  LEGAL_DOCUMENTS.find((doc) => doc.slug === slug) || null;
